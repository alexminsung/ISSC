...
>>>>>>> 759e53aa6c7c35f7d51ac0a90c23c0b9d3d72f1b

shelterData %>%
  filter(as.character(SECTOR) == "Co-ed" & as.character(OCCUPANCY_DATE) > "2020-03-001T00:00:00") %>%
...
shelterByCovid %>%
  ...
  ggplot(aes(x = OCCUPANCY_DATE, y = log_occupancy, color = ORGANIZATION_NAME)) + geom_point() + 
  facet_wrap(~ORGANIZATION_NAME) + geom_vline(aes(xintercept=""), color="black", linetype="dashed")
=======
  #+ geom_vline(aes(xintercept=""), color="black", linetype="dashed")
